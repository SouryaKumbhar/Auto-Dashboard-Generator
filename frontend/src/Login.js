...
function AnimatedBackground() {
  return (
    <>
      ...
      >
        <source
          src="/InfraBeat_True_Live_Wallpaper_1080p.mp4"
          type="video/mp4"
        />
      </video>
      ...
      <div
        style={{
          ...
          inset: 0,
          background:
            "linear-gradient(90deg, rgba(3,4,12,0.12), rgba(3,4,12,0.04), rgba(3,4,12,0.10))",
          zIndex: 1,
          pointerEvents: "none",
        }}
      />
...
export default function Login({ onLogin }) {
  ...
  // IMPORTANT:
  // Updated to the working login credentials
          ...
          onMouseEnter={(e) => {
            ...
            if (!loading) {
              ...
              e.currentTarget.style.boxShadow =
                "0 9px 32px rgba(124,58,237,0.60)";
